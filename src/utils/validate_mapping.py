...
# 분석 대상에서 제외할 USDA 코드 (미트박스 미취급 부위)
# 114/114A/114E/116B(전각), 116G(살치살), 167A/170/171B/184/184B/185B-D(설도)는
# part_mapping.CANONICAL_PARTS에 매핑되어 제외 목록에서 제거됨
EXCLUDED_CODES = {
    "113C", "114F",
    "160", "161", "168", "169", "169A", "171C",
    "174", "185A",
    "189A", "191A", "193",
}
