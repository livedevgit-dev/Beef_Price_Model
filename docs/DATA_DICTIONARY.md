...
| 컬럼명 | 데이터 타입 | 샘플 데이터 1 | 샘플 데이터 2 |
|---|---|---|---|
| std_date | object | 2026-08 | 2026-08 |
| 구분 | object | 미국 | 호주 |
| 부위별_갈비_합계 | float64 | 4267.6 | 3720.5 |
| 부위별_등심_합계 | float64 | 311.4 | 2178.5 |
| 부위별_목심_합계 | float64 | 1147.8 | 955.3 |
| 부위별_사태_합계 | float64 | 104.4 | 517.4 |
| 부위별_설도_합계 | float64 | 84.0 | 2161.2 |
| 부위별_안심_합계 | float64 | 9.2 | 27.8 |
| 부위별_앞다리_합계 | float64 | 944.4 | 3247.3 |
| 부위별_양지_합계 | float64 | 2965.0 | 2744.6 |
| 부위별_우둔_합계 | float64 | 0.0 | 1893.0 |
| 부위별_채끝_합계 | float64 | 0.0 | 147.0 |
| 부위별_기타_합계 | float64 | 0.0 | 3316.2 |
| 부위별_계_합계 | float64 | 19667.6 | 41817.50000000001 |
...
| 컬럼명 | 데이터 타입 | 샘플 데이터 1 | 샘플 데이터 2 |
|---|---|---|---|
| report_date | object | 09/14/2026 | 09/14/2026 |
...
| number_trades | float64 | 31.0 | nan |
| total_pounds | object | 288,348 | nan |
| price_range_low | float64 | 440.0 | nan |
| price_range_high | float64 | 504.53 | nan |
| weighted_average | float64 | 465.24 | nan |
...
| published_date | object | 09/14/2026 14:45:10 | 09/14/2026 14:45:10 |
...
| 컬럼명 | 데이터 타입 | 샘플 데이터 1 | 샘플 데이터 2 |
|---|---|---|---|
| date | object | 2026-08-11 | 2026-08-12 |
| category | object | 미국 | 미국 |
| part | object | BBQ등갈비 | BBQ등갈비 |
| brand | object | 엑셀(86K) | 엑셀(86K) |
| wholesale_price | float64 | 10760.0 | 10760.0 |
| ma7 | float64 | nan | nan |
| ma30 | float64 | nan | nan |
| min_total | float64 | 10760.0 | 10760.0 |
| max_total | float64 | 11800.0 | 11800.0 |
...
| 소스 | object | 미트박스 | USDA |
| 주기 | object | 일 | 일 |
| 최신데이터 | object | 2026-09-17 | 2026-09-14 |
| 지연(일) | int64 | 0 | 3 |
| 상태 | object | 최신 | 최신 |
...
| n_days | int64 | 549 | 546 |
| coverage_pct | int64 | 91 | 91 |
| recent_days | int64 | 38 | 36 |
| max_gap | int64 | 1 | 56 |
...
| 컬럼명 | 데이터 타입 | 샘플 데이터 1 | 샘플 데이터 2 |
|---|---|---|---|
| part | object | 황제늑간 | 차돌박이 |
| tier | int64 | 1 | 1 |
| current_price | int64 | 21550 | 21655 |
| pct_rank | int64 | 99 | 99 |
| momentum_30d | float64 | 1.9 | 9.6 |
